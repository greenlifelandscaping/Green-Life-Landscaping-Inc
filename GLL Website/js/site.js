  ...
  <div class="container">
    <div class="nav-inner">
      <a href="index.html" class="nav-logo">
        <img src="assets/logo-primary.png" alt="Green Life Landscaping Inc">
      </a>
      <div class="nav-links">
...
<footer>
  <div class="container">
    <div class="footer-grid">
      <div>
        <div class="footer-logo"><img src="assets/logo-primary.png" alt="Green Life Landscaping"></div>
...
function initSite(activePage) {
  ...
  if (navTarget) navTarget.outerHTML = fixPaths(NAV_HTML);

  // Inject floating CTA
  const ctaTarget = document.getElementById('floating-cta-placeholder');
  if (ctaTarget) ctaTarget.outerHTML = fixPaths(FLOATING_CTA_HTML);

  // Inject footer
  const footerTarget = document.getElementById('footer-placeholder');
  if (footerTarget) footerTarget.outerHTML = fixPaths(FOOTER_HTML);
